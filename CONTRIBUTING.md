...
[WeatherApp Code of Conduct](https://github.com/furkanaskin/Weatherappblob/master/CODE_OF_CONDUCT.md).
...
- Open an [Issue](https://github.com/furkanaskin/Weatherappissues/new). (Since we can't be sure at this point whether it is a bug or not, we ask you not to talk about a bug yet and not to label the issue.)
